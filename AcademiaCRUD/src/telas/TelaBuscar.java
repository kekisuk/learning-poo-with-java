...
public class TelaBuscar extends JFrame {
	...
	private JLabel jlTituloBusca = new JLabel("Atlhetic System | Busca de cliente");
	...
	public void montaJanelaBuscar() {
		preparaPainelBusca();
		preparaJFrame();
		preparaBotoes();
	}
	
	public void preparaPainelBusca() {
	...
	public void preparaJFrame() {
		...
		setTitle("Athletic System - Busca de Cliente");
